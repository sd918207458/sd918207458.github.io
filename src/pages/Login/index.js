...
const Login = () => {
  ...
  const dialogs = [
    ...
    { title: '阿公', content: '「以前在糖廠工作的時候啊，因為要搬運甘蔗過去，每次在大太陽底下運甘蔗吼，都滿身汗。」', imageUrl: grandpa4 },
    { title: '阿公', content: '「我們就在這附近玩相撲，玩盡興了再到手水舍這邊洗澡。」', imageUrl: grandpa4 },
    //第五章：神社-三崁店社
    ...
    { title: '阿公', content: '「在這裡度過這麼久的時光...許多事物早已物是人非...」', imageUrl: grandpa6 },
    { title: '阿公', content: '「我想我的心願...應該是能在糖廠還在的時候，再來神社這邊看看，再到郵局這邊寄信吧...」', imageUrl: grandpa6 },
    { title: '阿公', content: '「可惜阿...早一看不見那心中最懷念的景色了...」', imageUrl: grandpa6 },
    { title: '阿民', content: '「阿公...雖然我們沒辦法回到那個年代去欣賞糖廠興盛的樣貌，不過我們可以在這地方拍張照片。」', imageUrl: kids4 },
    { title: '阿民', content: '「我們的心中依然會留作美麗紀念，讓這個特別的時刻永遠保存下來。」', imageUrl: kids4 },
